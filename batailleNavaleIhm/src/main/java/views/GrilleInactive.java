...
public class GrilleInactive {
    private Controleur monControleur;
    @FXML
    private VBox maVbox;


    public static GrilleInactive creerEtAfficher(Controleur controleur, Stage primaryStage) {
        URL location = GrilleInactive.class.getResource("/views/grilleInactive.fxml");
        ...
        GrilleInactive vue = fxmlLoader.getController();
